...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "68fab95d1ec5a2b67f264e01";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  systemd.services.polyflow_startup = {
    ...
    serviceConfig = {
      ...
      DIRECTORY="/home/${user}/polyflow_robot_68fab95d1ec5a2b67f264e01"
      if [[ -d "$DIRECTORY" ]];
        then
          cd "$DIRECTORY"
          ...
          ${ros-pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_68fab95d1ec5a2b67f264e01.git
          chown -R ${user}:users /home/${user}/polyflow_robot_68fab95d1ec5a2b67f264e01

          cd /home/${user}/polyflow_robot_68fab95d1ec5a2b67f264e01/workspace
          ${ros-pkgs.colcon}/bin/colcon build --packages-select webrtc
          source install/setup.bash
          cd src/webrtc

          ${ros-pkgs.rosPackages.humble.ros2cli}/bin/ros2 launch launch/webrtc.launch.py
        fi
      ''}";
